...
namespace PL.Bakkal
{
    public partial class Stok : Form
    {
        ...
        private void Stok_Load(object sender, EventArgs e)
        {
            ...
            txtKategoriSec.Clear();
            txtKategoriSec.Focus();
        ...
        {
            if (txtKategoriSec.Text != "")
            {
                cbKategori.DataSource = sr.KategoriGetirByArama(txtKategoriSec.Text);
